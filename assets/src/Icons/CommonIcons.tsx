export const Tick = () => {
    ...
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="green" class="bi bi-bookmark-check-fill" viewBox="0 0 16 16">
...
export const X = () => {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="red" class="bi bi-bookmark-x-fill" viewBox="0 0 16 16">
